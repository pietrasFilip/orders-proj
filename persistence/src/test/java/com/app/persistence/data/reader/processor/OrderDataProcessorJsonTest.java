...
class OrderDataProcessorJsonTest {
    @Autowired
    OrderDataProcessor orderDataJsonProcessor;
    ...
    void test1() {
        ...
        var path = Paths
                .get("src", "test", "data", "test-orders.json")
                .toFile()
                .getAbsolutePath();

        assertThat(orderDataJsonProcessor.process(path))
                .hasSize(2)
